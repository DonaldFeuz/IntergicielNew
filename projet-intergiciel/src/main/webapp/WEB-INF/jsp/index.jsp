...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">La Finance en un click</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Transaction</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/banque.jpg"
				alt="logo banque" />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome CAMFINANCE</h1>
			<!-- Icon Divider-->
	...
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Transaction</h2>
			<!-- Icon Divider-->
			<div class="divider-custom">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
				...
				<div class="col-lg-8 col-xl-7">
					...
					<form id="contactForm" data-sb-form-api-token="API_TOKEN">
						...
						<div class="form-floating mb-3">
							<input class="form-control" id="name" type="text" name="emetteur"
								placeholder="Enter your name..." data-sb-validations="required" />
							<label for="name">Emetteur</label>
							<div class="invalid-feedback" data-sb-feedback="name:required">A
								name is required.</div>
						</div>
						<!-- Email address input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="prenom" name="recepteur" type="text"
								data-sb-validations="required,email" /> <label for="email">Recepteur</label>
						...
						<!-- Phone number input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="phone" name="montant" type="number"
								 data-sb-validations="required" />
							<label for="phone">Montant</label>
							<div class="invalid-feedback" data-sb-feedback="phone:required">A
								le montant est requis.</div>
						</div>
						<br>
						<label for="standard-select" name="devise" style="font-size: 20px;">Sélectionner la devise</label>
						<div class="form-floating mb-3">
							<div class="select">
								<select id="standard-select" class="form-control">
									<option value="Cameroun">XAF</option>
									<option value="Nigéria">EURO</option>
									<option value="Gabon">Dollar Canadien</option>
									<option value="Tchad">Dollar Américain</option>
									<option value="Maroc">Naira</option>
								</select>
							</div>
						</div>
						...
						<!-- Question input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="name" type="text" name="question"
								placeholder="Enter your name..." data-sb-validations="required" />
							<label for="name">Question ?</label>
							<div class="invalid-feedback" data-sb-feedback="name:required">Question.</div>
						</div>

						<!-- Message input-->
						<div class="form-floating mb-3">
							<textarea class="form-control" name="reponse" id="message" type="text"
								placeholder="Enter your message here..." style="height: 10rem"
								data-sb-validations="required"></textarea>
							<label for="message">Reponse</label>
							<div class="invalid-feedback" data-sb-feedback="message:required">Une proposition
								de réponse est obligatoire
							</div>
						</div>
